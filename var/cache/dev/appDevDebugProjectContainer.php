...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'forestal_dev', 'user' => 'geonode', 'password' => 'geonode', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->addCustomNumericFunction('numeric_functions', NULL);
        $b->addCustomNumericFunction('st_contains', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\STContains');
        $b->addCustomNumericFunction('contains', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\Contains');
        $b->addCustomNumericFunction('st_area', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\Area');
        $b->addCustomNumericFunction('st_geomfromtext', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\GeomFromText');
        $b->addCustomNumericFunction('st_intersects', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\STIntersects');
        $b->addCustomNumericFunction('st_buffer', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\STBuffer');
        $b->addCustomNumericFunction('point', 'CrEOF\\Spatial\\ORM\\Query\\AST\\Functions\\MySql\\Point');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f2a211b72840c4e2819e7f5c353c97129c2f219a12ece613af536b075f3df925');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('96c9d08af535ad9526efbeff2dc1c654d478c1d4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('579a083261a5c4.35709734')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '96c9d08af535ad9526efbeff2dc1c654d478c1d4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '96c9d08af535ad9526efbeff2dc1c654d478c1d4',
