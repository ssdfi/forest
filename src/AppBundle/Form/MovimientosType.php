    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
      //fecha de entrada + inspector + responsable + Si el expediente es plurianual entonces tiene que tener si o si: ETAPA
        $builder
            ...
            ->add('responsable',EntityType::class, array('class'=>'AppBundle\Entity\Responsables','group_by'=> function($dato) { if ($dato->getActivo() == false) { return 'Inactivos'; } else { return 'Activo'; } }))
            ...
            ->add('validador',EntityType::class, array('class'=>'AppBundle\Entity\Responsables','group_by'=> function($dato) { if ($dato->getActivo() == false) { return 'Inactivos'; } else { return 'Activo'; } }))
