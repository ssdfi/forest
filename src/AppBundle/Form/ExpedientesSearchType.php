...
class ExpedientesSearchType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ($filter == 0) { // si es usuario comun.
          $builder
          ...
          ->add('anio', NumberType::class, array("attr"=> array("class"=>"form-control",'placeholder'=>"AAAA"),'required'=>false,'label'=>'Año/Etapa'))
          ...
          ->add('agrupado', ChoiceType::class, array('choices'=>array('Todos'=>null,'Sí'=>true, 'No'=>false),"attr"=> array("class"=>"form-control"),'expanded'=>true, 'multiple'=>false,'empty_data'=>false))
          ->add('analizar', ChoiceType::class, array('choices'=>array('Todos'=>null,'Sí'=>true, 'No'=>false),"attr"=> array("class"=>"form-control"), 'expanded'=>true,'multiple'=>false,'empty_data'=>false, 'mapped'=>false, 'label'=>'Para Analizar'))
